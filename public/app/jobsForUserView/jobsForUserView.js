...
angular.module('myAppRename.jobsForUserView', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/jobsForUserView', {
            templateUrl: 'app/jobsForUserView/jobsForUserView.html',
            controller: 'jobsForUserViewCtrl'
        });
    }])

    .controller('jobsForUserViewCtrl', ['$scope', '$http', function ($scope, $http) {
        $scope.loading = false;
